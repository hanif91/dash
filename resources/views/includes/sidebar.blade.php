<div class="nav-header" >
    <a href="#" class="brand-logo">
        <img src="{{ asset('assets/images/D1.png') }}" width="50" height="50">
...
<div class="dlabnav">
    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="true">
                ...
                <ul aria-expanded="false" class="mm-collapse mm-show">
                    <li><a href="{{ route('dash.index') }}">Dashboard Home</a></li>
        ...
        {{-- <div class="copyright">
            <p><strong>DompetAdmin Dashboard</strong> © 2022 All Rights Reserved</p>
